...
public class JavaV {
    ...
    public static final String KAFKA_ZK_SESSION_TIMEOUT = "sjtumaster.kafka.zk.session.timeout";
    public static final String KAFKA_ZK_SYNC_TIME = "sjtumaster.kafka.zk.sync.time";
